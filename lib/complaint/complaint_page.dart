...
class AdminComplainPage extends StatefulWidget {
  ...
  String name;
  String college;
  AdminComplainPage(this.uid,this.studentEmail,this.name,this.college);
  @override
  _AdminComplainPageState createState() => _AdminComplainPageState();
}
...
class _AdminComplainPageState extends State<AdminComplainPage> {
  ...
  void initState() {
    ...
    complaintSub?.cancel();
    complaintSub=ref.snapshots().listen((QuerySnapshot snapshot) {
